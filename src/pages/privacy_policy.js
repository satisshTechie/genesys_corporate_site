    ...
    <Wrapper>
      <Layout>
        <Hero>
          ...
          <Last_edit>Last Revised : Juy 20, 2021</Last_edit>
        </Hero>
        <Document>
          <p>Welcome to Genesys Technovation!</p>
          <p>
            Welcome to Genesys Technovation! These terms and conditions outline
            the rules and regulations for the use of Company Name's Website,
          ...
          <p>
            ...
            to use cookies in agreement with the Genesys Technovation Privacy
            Policy.
          </p>
          <p>
            {" "}
          ...
          <p>
            {" "}
            No use of Genesys Technovation logo or other artwork will be allowed
